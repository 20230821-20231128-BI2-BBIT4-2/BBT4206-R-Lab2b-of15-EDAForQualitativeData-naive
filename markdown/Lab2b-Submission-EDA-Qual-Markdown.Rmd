...
# \Step5 Data cleansing for qualitative data\>

In this step we performed the following tasks: expanding contractions, evaluation of likes and wishes and removal of special characters
...
this is a text processing procedure used to reduce words to their base or 'stem' which is aimed to simplify words to their common root. lemmatization however is seen as a better option compared to stemming as the words maintain meaning and has less grammatical errors. Tokenization is a step used in nlp for it allows text data to be represnted in a format that can be used for further analysisand machine lerning tasks.
...
in this step a word count is performed on all comments made on evaluations and likes per gender.
...
```
## \Step7 top words\>
top 10 words for each gender and group in evaluation and likes
...
## \word cloud\>
this are visual representations of statistical data. in this case the words being highlighted are top word counts for evaluation and likes. However this method is not suitable in certain contexts where the user wants to know of the context of the represented data.
...
## \Step9: term frequency\>
this quantifies just how important various terms are ineach comment in relation to all comments made
